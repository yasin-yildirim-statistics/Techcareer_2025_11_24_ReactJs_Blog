  ...
  render() {
    ...
    let footerMiddleSide = (
      <div className="col-md-2 col-lg-2 col-xl-4 mx-auto mb-4">
        ...
        <p>
          Company INC Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda beatae
          distinctio eligendi fugiat iusto neque quidem quo sapiente voluptates voluptatibus?
        </p>
      </div>
    );
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          >
            2020 - {newDateYear()} {this.props.copy}
          </div>
        </footer>
      </React.Fragment>
    ); /* end return*/
